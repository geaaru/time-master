...
var defaultLogger *TmLogger = nil

func NewTmLogger(config *specs.TimeMasterConfig) *TmLogger {
	return &TmLogger{
		Logger: nil,
...
func (l *TmLogger) GetAurora() aurora.Aurora {
	return l.Aurora
}

func (l *TmLogger) SetAsDefault() {
	defaultLogger = l
}

func GetDefaultLogger() *TmLogger {
	return defaultLogger
}

func (l *TmLogger) InitLogger2File() error {
	var err error
...
func (l *TmLogger) log2File(level, msg string) {
	switch level {
	case "error":
		l.Logger.Error(msg)
	case "warning":
...
func (l *TmLogger) msg(level string, withoutColor bool, msg ...interface{}) {
	var message string
...
func (l *TmLogger) Warning(mess ...interface{}) {
...
func (l *TmLogger) Debug(mess ...interface{}) {
	l.msg("debug", false, mess...)
}

func (l *TmLogger) DebugC(mess ...interface{}) {
	l.msg("debug", true, mess...)
}

func (l *TmLogger) Info(mess ...interface{}) {
	l.msg("info", false, mess...)
}

func (l *TmLogger) InfoC(mess ...interface{}) {
	l.msg("info", true, mess...)
}

func (l *TmLogger) Error(mess ...interface{}) {
	l.msg("error", false, mess...)
}

func (l *TmLogger) Fatal(mess ...interface{}) {
	l.Error(mess)
	os.Exit(1)
}
